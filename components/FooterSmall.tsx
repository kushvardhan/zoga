  ...
  return (
    <footer className="bg-zinc-100 dark:bg-black border-t border-zinc-200 dark:border-zinc-800 py-16 mt-32">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        {/* Column 2 */}
        <div>
          <h3 className="font-bold text-zinc-800 dark:text-zinc-200 mb-3">Company</h3>
        ...
        {/* Column 3 */}
        <div>
          <h3 className="font-bold text-zinc-800 dark:text-zinc-200 mb-3">Services</h3>
          <div className="flex flex-col gap-2 text-zinc-500 dark:text-zinc-400">
        ...
        {/* Column 4 */}
        <div>
          <h3 className="font-bold text-zinc-800 dark:text-zinc-200 mb-3">Contact</h3>
          <p className="text-zinc-500 dark:text-zinc-400">
            support@zoga.studio  
            <br />
            +91 98765 43210
