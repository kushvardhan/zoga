...
import { 
  ...
  useMotionTemplate, useMotionValue, useInView 
} from 'framer-motion';
import { 
  ...
  ShieldCheck, Rocket, MousePointer2, Gem, Instagram, Twitter, Facebook,
  Megaphone, CheckCircle2, BarChart3, Users, Lightbulb
} from 'lucide-react';
...
const REVIEWS = [
  { name: "Elena Roderick", title: "CMO, FutureScale", quote: "The ROI we saw from the SEO campaign was instant. Zoga literally put us on the map." },
  { name: "Marcus Chen", title: "Founder, TechFlow", quote: "Their video editing team turned our boring corporate footage into a Netflix-style documentary." },
  { name: "Sarah Jenkins", title: "Product Lead, Apex", quote: "The app is flawless. Smooth animations, zero bugs, and 5-star reviews on the App Store." },
  { name: "David O'Connell", title: "Owner, Bean&Brew", quote: "We doubled our local foot traffic in 3 months thanks to their GMB wizardry." },
  { name: "Priya Patel", title: "Director, LuxeEstates", quote: "A design language that speaks luxury. They understood our brand better than we did." },
  { name: "James Thorne", title: "CEO, Nebula", quote: "Engineering at the speed of light. The Next.js build is incredibly fast." },
];

const portfolioCategories = [
  { id: 'all', label: 'All', icon: Layers, desc: 'Our finest digital engineering.' },
  { id: 'web-app-dev', label: 'Web & App Dev', icon: Code, desc: 'High-performance Next.js & Native architectures.', serviceLink: 'services' },
  { id: 'web-design', label: 'Web Design', icon: Layout, desc: 'Award-winning UI/UX and visual storytelling.', serviceLink: 'services' },
  { id: 'video-editing', label: 'Video Editing', icon: Video, desc: 'Cinematic post-production and motion graphics.', serviceLink: 'services' },
  { id: 'seo', label: 'SEO', icon: TrendingUp, desc: 'Data-driven dominance of search results.', serviceLink: 'services' },
  { id: 'designing', label: 'Designing', icon: PenTool, desc: 'Brand identity, logos, and design systems.', serviceLink: 'services' },
  { id: 'digital-marketing', label: 'Digital Marketing', icon: Megaphone, desc: 'Growth campaigns that convert.', serviceLink: 'services' },
  { id: 'gmb', label: 'GMB', icon: MapPin, desc: 'Local SEO and Google Maps optimization.', serviceLink: 'services' },
];

const projects = [
  { id: 1, title: 'Nebula Finance', cat: 'web-app-dev', size: 'large', img: 'https://images.unsplash.com/photo-1642427749670-f20e2e76ed8c?q=80&w=2000&auto=format&fit=crop', tags: ['Next.js', 'FinTech'] },
  { id: 2, title: 'Apex Fitness', cat: 'web-app-dev', size: 'small', img: 'https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=1000&auto=format&fit=crop', tags: ['iOS', 'React Native'] },
  { id: 3, title: 'Luxe Estates', cat: 'seo', size: 'tall', img: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=1000&auto=format&fit=crop', tags: ['SEO', 'Growth'] },
  { id: 4, title: 'Neon Cyberpunk', cat: 'video-editing', size: 'wide', img: 'https://images.unsplash.com/photo-1535016120720-40c6874c3b1c?q=80&w=1000&auto=format&fit=crop', tags: ['VFX', 'Premiere'] },
  { id: 5, title: 'Zenith Brand', cat: 'designing', size: 'small', img: 'https://images.unsplash.com/photo-1600607686527-6fb886090705?q=80&w=1000&auto=format&fit=crop', tags: ['Identity', 'Figma'] },
  { id: 6, title: 'Bean & Brew', cat: 'gmb', size: 'small', img: 'https://images.unsplash.com/photo-1517433670267-08bbd4be890f?q=80&w=1000&auto=format&fit=crop', tags: ['GMB', 'Local Maps'] },
  { id: 7, title: 'Crypto Dash', cat: 'web-design', size: 'tall', img: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=1000&auto=format&fit=crop', tags: ['UI/UX', 'Web3'] },
  { id: 8, title: 'Fashion Edit', cat: 'video-editing', size: 'small', img: 'https://images.unsplash.com/photo-1492633423870-43d1cd2775eb?q=80&w=1000&auto=format&fit=crop', tags: ['4K', 'Grading'] },
  { id: 9, title: 'Urban E-Com', cat: 'digital-marketing', size: 'wide', img: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1000&auto=format&fit=crop', tags: ['Ads', 'Conversion'] },
];

const team = [
  { name: "Alex V.", roles: ["Creative Dir", "UI/UX"], img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&fit=crop" },
  { name: "Sarah J.", roles: ["Lead Dev", "System Arch"], img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=400&fit=crop" },
  { name: "Davide R.", roles: ["3D Motion", "VFX"], img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=400&fit=crop" },
  { name: "Emily W.", roles: ["SEO Strat", "Growth"], img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400&fit=crop" },
  { name: "Marcus L.", roles: ["Full Stack", "Security"], img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=400&fit=crop" },
  { name: "Priya K.", roles: ["Copywriter", "Brand"], img: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=400&fit=crop" },
];
...
const ReviewsSection = () => {
  ...
  return (
    <section className="relative py-32 bg-zinc-50 dark:bg-black overflow-hidden">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-24 md:w-48 bg-gradient-to-r from-zinc-50 dark:from-black to-transparent z-20 pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-24 md:w-48 bg-gradient-to-l from-zinc-50 dark:from-black to-transparent z-20 pointer-events-none" />
                ...
                <div className="flex flex-col h-full justify-between">
                  ...
                  <div className="flex items-center gap-4 mt-auto">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-purple-500 dark:text-purple-400 uppercase tracking-wide font-bold">{review.title}</p>
                    </div>
                  </div>
                </div>
              </SpotlightCard>
...
const BrandMarquee = () => {
  const brands = [
    'GOOGLE', 'AMAZON', 'NIKE', 'SPOTIFY', 'UBER', 'AIRBNB',
    'NETFLIX', 'TESLA', 'STRIPE', 'APPLE', 'FIGMA', 'SHOPIFY'
  ];
        ...
        >
          {brandLoop.map((logo, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`group relative hover-${color}`}
              >
                <div className="
                  marquee-pill 
                  px-8 py-3 
                  ...
                  cursor-default
                ">
                  <span title={logo} className="cursor-pointer text-xl md:text-2xl font-black text-zinc-600 dark:text-zinc-400">
                    {logo}
                  </span>
                </div>
              </div>
...
const ProcessSection = () => {
    const steps = [
        { icon: Lightbulb, title: "Discovery", desc: "We dig deep into your brand DNA to find the unique angle." },
        { icon: PenTool, title: "Craft", desc: "Pixel-perfect design meets robust engineering." },
        { icon: Rocket, title: "Launch", desc: "Deployment strategies that ensure 100% uptime and speed." },
        { icon: BarChart3, title: "Scale", desc: "Continuous optimization based on real user data." }
    ];
        ...
        <section className="py-32 px-6 bg-white dark:bg-black border-t border-zinc-200 dark:border-zinc-800">
            <div className="max-w-7xl mx-auto">
                <FadeIn className="mb-20 text-center">
                    <h2 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white mb-6">How We <span className="text-purple-500">Win.</span></h2>
                    <p className="text-zinc-500 max-w-2xl mx-auto">Our battle-tested methodology for digital dominance.</p>
                </FadeIn>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {steps.map((step, i) => (
                        <FadeIn key={i} delay={i * 0.1} className="relative">
                            ...
                            <h3 className="text-xl font-bold text-center text-zinc-900 dark:text-white mb-3">{step.title}</h3>
    ...
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      <div className="md:col-span-2">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 max-w-sm mb-8">
          We engineer digital dominance. A full-service creative agency building the future of the web, one pixel at a time.
        </p>
      ...
      <div>
        ...
        <ul className="space-y-4 text-zinc-500 dark:text-zinc-400">
          <li><button onClick={() => setView('about')} className="hover:text-purple-500 transition-colors">About Us</button></li>
          <li><button onClick={() => setView('work')} className="hover:text-purple-500 transition-colors">Portfolio</button></li>
          <li><button onClick={() => setView('services')} className="hover:text-purple-500 transition-colors">Services</button></li>
          <li><button onClick={() => setView('contact')} className="hover:text-purple-500 transition-colors">Contact</button></li>
        </ul>
      </div>
...
const AboutPage = ({ setView }: { setView: (view: string) => void }) => {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden bg-zinc-50 dark:bg-black transition-colors duration-700">
      ...
      <section className="relative h-screen flex flex-col justify-center items-center px-6 overflow-hidden">
        <motion.div style={{ y: yOrb, rotate: rotateOrb }} className="absolute top-1/4 right-0 w-[800px] h-[800px] bg-gradient-to-br from-purple-600/30 to-blue-600/10 rounded-full blur-[120px] pointer-events-none mix-blend-multiply dark:mix-blend-screen" />
        <motion.div style={{ y: yHero }} className="relative z-10 max-w-6xl mx-auto text-center">
          <FadeIn>
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full border border-zinc-300 dark:border-zinc-800 bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl mb-12 shadow-lg">
               ...
               <span className="text-xs font-bold text-zinc-600 dark:text-zinc-300 uppercase tracking-widest">System Online // Global Reach</span>
            </div>
          </FadeIn>
          <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-black tracking-tighter text-zinc-900 dark:text-white mb-8 leading-[0.85]">
            <span className="block overflow-hidden"><motion.span initial={{ y: "100%" }} animate={{ y: 0 }} transition={{ duration: 0.8 }} className="block">BEYOND</motion.span></span>
            <span className="block overflow-hidden text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-blue-500 to-cyan-500"><motion.span initial={{ y: "100%" }} animate={{ y: 0 }} transition={{ duration: 0.8, delay: 0.1 }} className="block">THE CODE</motion.span></span>
          </h1>
          <FadeIn delay={0.3}>
            <p className="max-w-3xl mx-auto text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 leading-relaxed font-light">
              We are the architects of the new internet. Merging <span className="font-bold text-zinc-900 dark:text-white">chaotic art</span> with <span className="font-bold text-zinc-900 dark:text-white">disciplined engineering</span>.
            </p>
          </FadeIn>
        </motion.div>
      </section>
             ...
             {[
                ...
                <FadeIn key={i} delay={i * 0.1}>
                    <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center border-l-4 border-purple-500 pl-8 md:pl-12 hover:pl-16 transition-all duration-500">
                        <h3 className="text-5xl md:text-7xl font-black text-zinc-900 dark:text-white w-full md:w-1/2 leading-[0.9] tracking-tight">{item.title}</h3>
                        <p className="text-lg md:text-2xl text-zinc-600 dark:text-zinc-400 w-full md:w-1/2 leading-relaxed font-light">{item.text}</p>
                    </div>
                </FadeIn>
             ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <FadeIn>
            <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-zinc-200 dark:border-zinc-800 pb-6">
               <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white">The Architects</h2>
                  <p className="text-zinc-500 mt-2">A multidisciplinary collective.</p>
               </div>
               <button onClick={() => setView('work')} className="text-purple-500 font-bold flex items-center gap-2 hover:gap-4 transition-all mt-4 md:mt-0">
...
const PortfolioPage = ({ setView }: { setView: (view: string) => void }) => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen pt-24 bg-zinc-50 dark:bg-black transition-colors duration-700">
       <div className="fixed inset-0 pointer-events-none opacity-30 z-0 mix-blend-overlay" style={{ backgroundImage: "url('https://grainy-gradients.vercel.app/noise.svg')" }} />
       ...
       <section className="relative px-6 text-center mb-16 overflow-hidden pt-20">
          <motion.div style={{ y: yHero }} className="relative z-10">
            ...
            <FadeIn delay={0.1}>
                ...
                OUR <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">WORK</span>
                </h1>
            </FadeIn>
            <FadeIn delay={0.2}>
                <p className="text-xl md:text-2xl text-zinc-500 dark:text-zinc-400 max-w-3xl mx-auto mb-12 font-light">
                Browse our galaxy of digital products. From high-conversion SEO campaigns to immersive 3D web experiences.
                </p>
            </FadeIn>
          </motion.div>
           ...
           <FadeIn direction='up'>
             <div className="flex flex-wrap justify-center gap-3">
               {portfolioCategories.map((cat) => (
                 ...
                 >
                   <cat.icon className={`w-4 h-4 ${filter === cat.id ? 'text-purple-400 dark:text-purple-600' : 'text-zinc-400 group-hover:text-purple-500'}`} />
                   {cat.label}
                 </button>
               ))}
             </div>
             ...
             <div className="max-w-7xl mx-auto bg-gradient-to-br from-zinc-100 to-zinc-200 dark:from-zinc-900 dark:to-black border border-purple-500/30 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-purple-500/10">
               <div className="text-left">
                  ...
                  <h3 className="text-3xl md:text-5xl font-black text-zinc-900 dark:text-white mb-4 tracking-tight">
                    Mastering <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">{activeCatData.label}</span>.
                  </h3>
                  <p className="text-zinc-600 dark:text-zinc-400 max-w-xl text-lg font-medium">
                    {activeCatData.desc} We combine data-driven insights with award-winning aesthetics.
                  </p>
               </div>
               <button 
          ...
          <AnimatePresence mode='popLayout'>
            {filteredProjects.map((project, i) => (
              <motion.div
                ...
                className={`${project.size === 'large' ? 'md:col-span-2 md:row-span-2' : ''} ${project.size === 'wide' ? 'md:col-span-2' : ''} ${project.size === 'tall' ? 'md:row-span-2' : ''}`}
              >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                            <div className="flex gap-2 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                                {project.tags.map(tag => (
                                    <span key={tag} className="text-[10px] uppercase font-bold px-2 py-1 bg-white/20 backdrop-blur-md rounded text-white">{tag}</span>
                                ))}
                            </div>
      ...
      <section className="py-32 px-6 bg-zinc-900 dark:bg-black text-white relative overflow-hidden z-10">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
           <FadeIn>
             <h2 className="text-5xl md:text-8xl font-black tracking-tighter mb-8">Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">Scale?</span></h2>
             <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto">
                Stop playing small. Join the roster of elite brands dominating their industry with Zoga.
             </p>
             <button onClick={() => setView('contact')} className="px-12 py-6 bg-white text-black rounded-full text-xl font-bold hover:scale-105 hover:shadow-[0_0_50px_rgba(255,255,255,0.3)] transition-all flex items-center gap-3 mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <FadeIn className="text-center mb-20">
            <h1 className="text-6xl md:text-8xl font-extrabold tracking-tighter text-zinc-900 dark:text-white mb-6">
                <span className="block">Services Engineered</span> for <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-blue-500">Growth</span>
            </h1>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-24">
          {[
            ...
            { icon: Smartphone, title: "App Development", desc: "iOS & Android" },
            { icon: TrendingUp, title: "SEO Strategy", desc: "Rank #1 on Google" },
            ...
            <FadeIn key={i} delay={i * 0.1}>
              <SpotlightCard className="p-8 rounded-3xl h-full">
                ...
                <p className="text-md text-zinc-600 dark:text-zinc-400 mb-6">{service.desc}</p>
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-700 ${darkMode ? 'bg-[#050505] text-white' : 'bg-zinc-50 text-zinc-900'} ${darkMode ? 'dark' : ''}`}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-zinc-200 dark:border-zinc-800 rounded-full px-6 py-3 flex items-center justify-between shadow-lg">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => setDarkMode(!darkMode)} className="p-2 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                {darkMode ? <Sun size={20} /> : <Moon size={20} />}
            </button>
            <button onClick={() => setView('contact')} className="hidden md:block px-6 py-2 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-full font-bold text-sm hover:scale-105 transition-transform">
                Let's Talk
            </button>
      ...
      <AnimatePresence>
        {menuOpen && (
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="fixed inset-0 z-40 bg-white dark:bg-black pt-24 px-6 md:hidden flex flex-col gap-6 text-2xl font-bold">
                <button onClick={() => setView('about')} className="text-left py-4 border-b border-zinc-200 dark:border-zinc-800">About</button>
                <button onClick={() => setView('work')} className="text-left py-4 border-b border-zinc-200 dark:border-zinc-800">Work</button>
                <button onClick={() => setView('services')} className="text-left py-4 border-b border-zinc-200 dark:border-zinc-800">Services</button>
                <button onClick={() => setView('contact')} className="text-left py-4 text-purple-500">Contact Us</button>
            </motion.div>
        )}
      </AnimatePresence>
      ...
      <main className="min-h-screen">
        <AnimatePresence mode='wait'>
            {view === 'about' && <motion.div key="about" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}><AboutPage setView={setView} /></motion.div>}
            {view === 'work' && <motion.div key="work" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}><PortfolioPage setView={setView} /></motion.div>}
            ...
            {view === 'contact' && (
                <motion.div key="contact" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}} className="pt-32 px-6 text-center min-h-screen flex flex-col items-center justify-center bg-zinc-50 dark:bg-black">
                    <h1 className="text-6xl font-black mb-6 dark:text-white">Let's start the conversation.</h1>
